...
export type FindOrganisationsForSitemapQueryVariables = Exact<{ [key: string]: never; }>;


export type FindOrganisationsForSitemapQuery = { __typename?: 'query_root', maintainer_organisation: Array<{ __typename?: 'maintainer_organisation', schema_name?: string | null, schema_identifier: string }> };
...
export const FindOrganisationsForSitemapDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FindOrganisationsForSitemap"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"maintainer_organisation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"schema_name"}},{"kind":"Field","name":{"kind":"Name","value":"schema_identifier"}}]}}]}}]} as unknown as DocumentNode<FindOrganisationsForSitemapQuery, FindOrganisationsForSitemapQueryVariables>;
