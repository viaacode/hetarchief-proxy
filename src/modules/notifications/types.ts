...
export enum NotificationType {
	...
	MATERIAL_REQUEST_UNREAD_MESSAGES_OUTGOING = 'MATERIAL_REQUEST_UNREAD_MESSAGES_OUTGOING',
	MATERIAL_REQUEST_UNREAD_MESSAGES_INCOMING = 'MATERIAL_REQUEST_UNREAD_MESSAGES_INCOMING',
}
