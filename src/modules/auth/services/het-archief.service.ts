...
import { DecodedSamlResponse, IdpMetaData, LdapUser, SamlCallbackBody } from '../types';

@Injectable()
export class HetArchiefService {
	...
	public async init() {
		const url = this.configService.get('samlIdpMetaDataEndpoint');
		try {
