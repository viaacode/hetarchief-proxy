...
export enum AdditionalRequirementErrors {
	ALREADY_HAS_PENDING_ADDITIONAL_REQUIREMENTS = 'ALREADY_HAS_PENDING_ADDITIONAL_REQUIREMENTS',
	NO_ADDITIONAL_CONDITIONS_TO_ACCEPT = 'NO_ADDITIONAL_CONDITIONS_TO_ACCEPT',
	ALREADY_ACCEPTED_ADDITIONAL_CONDITIONS = 'ALREADY_ACCEPTED_ADDITIONAL_CONDITIONS',
