...
export class TemplateService {
	public static getTemplateId(template: string): string {
		const templateIds = {
			[Template.SHARE_FOLDER]: process.env
				.CAMPAIGN_MONITOR_EMAIL_TEMPLATE_SHARE_FOLDER as string,
			...
			[Template.VISIT_APPROVED]: process.env
				.CAMPAIGN_MONITOR_TEMPLATE_VISIT_APPROVED as string,
