...
export const FIND_SPACE_BY_MAINTAINER_IDENTIFIER = `
  query getSpaceByMaintainerIdentifier($slug: String!) {
    cp_space(where: {schema_maintainer: {schema_identifier: {_ilike: $slug}}}) {
      id
      schema_image
      schema_color
      schema_audience_type
