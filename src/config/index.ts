...
const config = (): Configuration => {
	...
	const configValues = {
		...
		MATERIAL_REQUEST_TIME_BEFORE_ARCHIVATION: Number.parseFloat(
			getEnvValue('MATERIAL_REQUEST_TIME_BEFORE_ARCHIVATION', true)
		),
		MATERIAL_REQUEST_USE_DAYS_INSTEAD_MONTHS_BEFORE_ARCHIVATION:
			getEnvValue('MATERIAL_REQUEST_USE_DAYS_INSTEAD_MONTHS_BEFORE_ARCHIVATION', false) === 'true',
		MATERIAL_REQUEST_ADDITIONAL_REQUIREMENTS_REMINDER_DAYS: Number.parseFloat(
			getEnvValue('MATERIAL_REQUEST_ADDITIONAL_REQUIREMENTS_REMINDER_DAYS', true)
		),
		...
		ZENDESK_TOKEN_ENDPOINT: getEnvValue('ZENDESK_TOKEN_ENDPOINT', true),
		ZENDESK_CLIENT_ID: getEnvValue('ZENDESK_CLIENT_ID', true),
		ZENDESK_CLIENT_SECRET: getEnvValue('ZENDESK_CLIENT_SECRET', true),
		...
		MEDIAHAVEN_EXPORT_JOB_RETRY_DELAY_HOURS: Number.parseInt(
			getEnvValue('MEDIAHAVEN_EXPORT_JOB_RETRY_DELAY_HOURS', true)
		),
		MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_ENDPOINT: getEnvValue(
			'MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_ENDPOINT',
			true
		),
		MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_USERNAME: getEnvValue(
			'MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_USERNAME',
			true
		),
		MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_PASSWORD: getEnvValue(
			'MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_PASSWORD',
			true
		),
		MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_X_USER_SECRET_KEY_META: getEnvValue(
			'MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_X_USER_SECRET_KEY_META',
			true
		),
		MEDIAHAVEN_S3_EXPORT_LOCATION_URL: getEnvValue('MEDIAHAVEN_S3_EXPORT_LOCATION_URL', true),
		MEDIAHAVEN_S3_EXPORT_LOCATION_SIGNED_URL_EXPIRY_SECONDS: Number.parseInt(
			getEnvValue('MEDIAHAVEN_S3_EXPORT_LOCATION_SIGNED_URL_EXPIRY_SECONDS', true),
			10
		),
		MEDIAHAVEN_S3_EXPORT_LOCATION_BUCKET_URL: getEnvValue(
