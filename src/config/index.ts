...
const config = (): Configuration => {
	...
	return {
		...
		CAMPAIGN_MONITOR_SUBSCRIBER_API_VERSION: getEnvValue(
		...
		CAMPAIGN_MONITOR_TEMPLATE_CONFIRMATION__NL: getEnvValue(
			'CAMPAIGN_MONITOR_TEMPLATE_CONFIRMATION__NL',
			false
		),
		...
		CAMPAIGN_MONITOR_TEMPLATE_CONFIRMATION__EN: getEnvValue(
			'CAMPAIGN_MONITOR_TEMPLATE_CONFIRMATION__EN',
			false
		),
		...
		CAMPAIGN_MONITOR_OPTIN_LIST_HETARCHIEF_NEWSLETTER: getEnvValue(
