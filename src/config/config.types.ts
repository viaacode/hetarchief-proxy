...
export interface Configuration {
	...
	MATERIAL_REQUEST_DOWNLOAD_WARNING_DAYS_BEFORE_EXPIRING: number;
	MATERIAL_REQUEST_DOWNLOAD_DAYS_AVAILABLE: number;
	MATERIAL_REQUEST_ADDITIONAL_REQUIREMENTS_REMINDER_DAYS: number;
	MATERIAL_REQUEST_TIME_BEFORE_ARCHIVATION: number;
	MATERIAL_REQUEST_USE_DAYS_INSTEAD_MONTHS_BEFORE_ARCHIVATION: boolean;
	...
	MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_ENDPOINT: string;
	MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_USERNAME: string;
	MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_PASSWORD: string;
	MEDIAHAVEN_S3_EXPORT_LOCATION_TOKEN_X_USER_SECRET_KEY_META: string;
